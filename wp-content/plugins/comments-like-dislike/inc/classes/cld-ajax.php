...
if ( !class_exists( 'CLD_Ajax' ) ) {
	...
	class CLD_Ajax extends CLD_Library {
		...
		function __construct() {
			...
			// Unlike comment
			add_action( 'wp_ajax_cld_unlike_comment_ajax_action', array( $this, 'unlike_action' ) );
			add_action( 'wp_ajax_nopriv_cld_unlike_comment_ajax_action', array( $this, 'unlike_action' ) );
		}
